    ...
    McpServerMetadata(
        ...
        tools=_tools(
            ...
            (
                ...
                ("search_traces", READ),
                ("get_trace_by_id", READ),
                ("get_service_trace_summary", READ),
                ("get_trace_error_spans", READ),
                ...
                ("get_k8s_hpa", READ),
                ("get_k8s_service_endpoints", READ),
                ("get_k8s_ingress_backend_mapping", READ),
                ("get_pod_logs", READ),
                ("get_rollout_status", READ),
                ("check_onprem_metallb_endpoint", READ),
                ("check_onprem_ingress_route", READ),
                ("get_alertmanager_alerts", READ),
                ("get_sqs_queue_attributes", READ),
                ("get_sqs_dlq_attributes", READ),
                ...
                ("get_topology_snapshot", READ),
                ("search_topology_knowledge", READ),
                ("get_service_routing_path", READ),
                ("get_service_dependency_map", READ),
